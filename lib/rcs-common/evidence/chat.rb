...
module ChatEvidence
  ...
  def content
    program = "MSN\0".to_utf16le_binary
    ...
    content.write topic
    content.write users
    content.write KEYSTROKES.sample.to_utf16le_binary
